...
public class EdicaoFestival {
    ...
    // arrays auxiliares (apenas para efeito de atribuição de prémios)
    // cada array serve para inserir os atores/atrizes que estão aptos para serem selecionados para as diversas categorias
